...
struct SinOscWidget : ModuleWidget {
  SinOscWidget(SinOsc* module) {
    ...
    addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(15.24, 48.957)), module,
                                                 SinOsc::PITCH_PARAM));

    addInput(
        createInputCentered<PJ301MPort>(mm2px(Vec(15.24, 75.824)), module, SinOsc::PITCH_INPUT));

    addOutput(
        createOutputCentered<PJ301MPort>(mm2px(Vec(15.24, 102.949)), module, SinOsc::SINE_OUTPUT));

    addChild(createLightCentered<MediumLight<RedLight>>(mm2px(Vec(15.24, 24.713)), module,
                                                        SinOsc::BLINK_LIGHT));
  }
};
